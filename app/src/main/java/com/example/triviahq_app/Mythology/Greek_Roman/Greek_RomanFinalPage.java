...
public class Greek_RomanFinalPage extends AppCompatActivity {

    private Greek_Roman a = new Greek_Roman();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_greek_roman_final_page);
        ...
        againButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(Greek_RomanFinalPage.this, Greek_RomanQuestions.class);
                startActivity(a);
            }
        });
        ...
        mainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Greek_RomanFinalPage.this, MenuScreen.class);
                startActivity(b);
            }
        });
