...
public class NorseFinalPage extends AppCompatActivity {

    private Norse a = new Norse();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_norse_final_page);
        ...
        againButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(NorseFinalPage.this, NorseQuestions.class);
                startActivity(a);
            }
        });
        ...
        mainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(NorseFinalPage.this, MenuScreen.class);
                startActivity(b);
            }
        });
