...
public class AncientFinalPage extends AppCompatActivity {

    private Ancient an = new Ancient();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ancient_final_page);

        //Show final score
        finalScore = findViewById(R.id.scoreText);
        Bundle bundle = getIntent().getExtras();
        int score = bundle.getInt("finalScore");
        finalScore.setText("Your final score is: " + score + "/" + an.mQuestions.length);
        ...
        againButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(AncientFinalPage.this, AncientQuestions.class);
                startActivity(a);
            }
        });
        ...
        mainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(AncientFinalPage.this, MenuScreen.class);
                startActivity(b);
            }
        });
