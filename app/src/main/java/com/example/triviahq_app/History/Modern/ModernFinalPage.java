...
public class ModernFinalPage extends AppCompatActivity{

    private Modern m = new Modern();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modern_final_page);

        //Show final score
        finalScore = findViewById(R.id.scoreText);
        Bundle bundle = getIntent().getExtras();
        int score = bundle.getInt("finalScore");
        finalScore.setText("Your final score is: " + score + "/" + m.mQuestions.length);
        ...
        againButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(ModernFinalPage.this, ModernQuestions.class);
                startActivity(a);
            }
        });
        ...
        mainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(ModernFinalPage.this, MenuScreen.class);
                startActivity(b);
            }
        });
