...
public class RenaissanceFinalPage extends AppCompatActivity {

    private Renaissance r = new Renaissance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_renaissance_final_page);
        ...
        againButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(RenaissanceFinalPage.this, RenaissanceQuestions.class);
                startActivity(a);
            }
        });
        ...
        mainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(RenaissanceFinalPage.this, MenuScreen.class);
                startActivity(b);
            }
        });
